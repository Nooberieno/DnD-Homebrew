...
_Level 3 Abjuration Spell_<br>
**Casting Time**: 1 Reaction, which you take when you see a creature within 30 ft cast a spell with a verbal component.<br>
**Range**: 30 ft radius<br>
**Components**: V, S, M(a page worth of text you can't read)<br>
**Duration**: Instantaneous<br>
**Classes**: Sorcerer, Warlock, Druid, Bard<br>
