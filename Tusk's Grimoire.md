...
layout: default
---
_Requirement: Orc Lineage or knowing Orc as a language_
...
- **Dispel or Counter:** If a creature within the aura casts a spell that negates or diminishes others spells like _Dispel Magic_ or _Counterspell_, they gain a +2 bonus to the roll or their Saving DC to make the spell succeed.  
...
**Description**  
With the incendiary Hymn of Combustion, you channel destructive energy into a target within range. The target bursts into flames, taking fire damage equal to a number of d4 equal to your spellcasting modifier. Additionally, any creature within 5 feet of the target must succeed on a Dexterity saving throw or take half of the initial damage.
